...
def convert(root_dir: Path, out_path: Path, img_out_prefix: str,
    ...
    for split in splits:
        ...
        for img_path in image_files:
            ...
            for (class_id, xmin, ymin, w, h) in raw_boxes:
                ...
                # Denormalizing YOLO cx,cy,w,h lands a handful of boxes a few
                # ten-thousandths of a pixel outside the image, which
                # validate_schema.py (correctly) rejects.
                bbox, overshoot = clip_bbox(xmin, ymin, w, h, width, height)
    ...
    print(f"[RDD2022/Kaggle] bbox bounds: {clip_stats.summary()}")
